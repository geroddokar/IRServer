...
namespace IRServer.Controllers
{
    ...
    //            using (IrobusModel db = new IrobusModel())
    //            {
    //                user = db.Users.FirstOrDefault(u => u.Email == model.Email && u.PasswordHash == model.Password);
    //            }
    //            if (user != null)
    //            {
    ...
    //                using (IrobusModel db = new IrobusModel())
    //                {
    //                    db.Users.Add(new ApplicationUser { Email = model.Email, PasswordHash = model.Password });
    //                    db.SaveChanges();
