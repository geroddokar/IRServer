...
using WisdomCloud.Identity.Models;
using ExternalLoginConfirmationViewModel = IRServer.Models.ExternalLoginConfirmationViewModel;
using ForgotPasswordViewModel = IRServer.Models.ForgotPasswordViewModel;
using LoginViewModel = IRServer.Models.LoginViewModel;
using RegisterViewModel = IRServer.Models.RegisterViewModel;
using ResetPasswordViewModel = IRServer.Models.ResetPasswordViewModel;
using SendCodeViewModel = IRServer.Models.SendCodeViewModel;
using VerifyCodeViewModel = IRServer.Models.VerifyCodeViewModel;
...
namespace IRServer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult LogOff()
        {
            ...
            HttpContext.GetOwinContext().Authentication.SignOut(OAuthDefaults.AuthenticationType);
